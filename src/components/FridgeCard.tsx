      ...
      <div className="bg-white rounded-[2.5rem] p-4 pl-5 pr-4 flex items-center justify-between shadow-soft border border-slate-50/50 transition-all hover:shadow-xl hover:-translate-y-1 overflow-hidden">
        ...
        <div className="flex items-center gap-0.5 flex-shrink-0 ml-2">
          <button
            ...
            className="w-9 h-9 rounded-full flex items-center justify-center text-slate-200 hover:text-brand-500 hover:bg-brand-50 transition-all"
          >
          ...
          <button
            ...
            className="w-9 h-9 rounded-full flex items-center justify-center text-slate-100 hover:text-rose-400 hover:bg-rose-50 transition-all"
          >
            <svg className="w-4.5 h-4.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
